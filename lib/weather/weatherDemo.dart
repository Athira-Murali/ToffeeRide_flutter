...
class _WeatherDemoState extends State<WeatherDemo> {
  ...
  Future<Null> _loadAssets(AssetBundle bundle) async {
    ...
    await _images.load(<String>[
      'assets/toffee/clouds-0.png',
      'assets/toffee/clouds-1.png',
      'assets/toffee/ray.png',
      'assets/toffee/sun.png',
      'assets/toffee/weathersprites.png',
      'assets/toffee/icon1.png',
      'assets/toffee/icon2.png',
      'assets/toffee/icon3.png'
    ]);

    // Load the sprite sheet, which contains snowflakes and rain drops.
    String json = await DefaultAssetBundle.of(context).loadString('assets/toffee/weathersprites.json');
