...
class DotsJoin extends StatefulWidget {
  @override
  _DotsJoinState createState() => _DotsJoinState();
}

class _DotsJoinState extends State<DotsJoin> {
        ...
        body: GestureDetector(
          ...
          child: RepaintBoundary(
            ...
            child: Stack(
              children: <Widget>[
                Center(
                  child: Image.asset("assets/toffee/connect.png"),
                ),
                CustomPaint(
                  size: Size.infinite,
                  painter: MyPainter(
