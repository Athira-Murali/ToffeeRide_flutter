...
import 'package:background_music/ToffeeRideScreens/Game/Customline.dart';
...
class DashlineJoin extends StatefulWidget {
  @override
  _DashlineJoinState createState() => _DashlineJoinState();
}

class _DashlineJoinState extends State<DashlineJoin> {
...
//path
    final path = Path()..cubicTo(-10, 50, 14, 86, 61, 102);
